...
export const INITIAL_TASKS: TaskItem[] = [
  {
    id: 'tg_channel',
    category: 'social',
    titleUz: 'Lenzy Coin Rasmiy Kanaliga a\'zo bo\'ling (@lenzy_coin)',
    descriptionUz: 'Eng so\'nggi yangiliklar, airdrop va e\'lonlarni kuzatib boring',
    rewardCoins: 25000,
    isCompleted: false,
    isClaimed: false,
    actionUrl: 'https://t.me/lenzy_coin',
    targetChatId: '@lenzy_coin',
    iconName: 'Send',
    type: 'telegram'
  },
  {
    id: 'tg_community',
    category: 'social',
    titleUz: 'Lenzy Coin Rasmiy Chatiga qo\'shiling (@lenzy_coin_chat)',
    descriptionUz: 'Boshqa foydalanuvchilar bilan fikr almashing va savollarga javob oling',
    rewardCoins: 15000,
    isCompleted: false,
    isClaimed: false,
    actionUrl: 'https://t.me/lenzy_coin_chat',
    targetChatId: '@lenzy_coin_chat',
